      ...
      <nav style={{
        ...
        <div style={{
          ...
          <a href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center" }}>
            <img src="/logo.png" alt="WePrompt" style={{ height: 40, width: 'auto', display: 'block' }} />
          </a>
    ...
    <section style={{
      ...
      <div className="hero-pad" style={{ position: "relative", zIndex: 1, padding: "120px 48px 80px" }}>
        ...
        <motion.div
          ...
          <span style={{ color: "#6B7280", fontSize: 13 }}>O 1º marketplace de IA do Brasil</span>
        </motion.div>
        ...
        <motion.p
          ...
          style={{
            ...
            margin: "24px auto 0", fontWeight: 400,
          }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 480 }}>
          <div style={{ marginBottom: 20 }}>
            <img src="/logo-white.png" alt="WePrompt" style={{ height: 36, width: 'auto', display: 'block', filter: 'brightness(0) invert(1)' }} />
          </div>
          <p style={{
