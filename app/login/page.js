  ...
  return (
    <div style={{
      ...
      <div style={{
          ...
          {[["entrar", "Entrar"], ["criar", "Criar conta"]].map(([key, label]) => (
            <button
              ...
              style={{
                ...
                fontFamily: "inherit",
                background: tab === key ? "rgba(107,92,231,0.6)" : "transparent",
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: "#fff", marginBottom: 4, letterSpacing: "-0.4px" }}>
          {tab === "entrar" ? "Bem-vindo de volta" : "Comece gratuitamente"}
        </h1>
        <p style={{ fontSize: 14, color: TEXT2, marginBottom: 24 }}>
          {tab === "entrar" ? "Entre na sua conta WePrompt." : "Preencha seu email para criar sua conta."}
        </p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px 0" }}>
          ...
          <span style={{ fontSize: 12, color: TEXT2 }}>ou</span>
          <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }} />
        </div>
