          ...
          <div className="w-16 h-16 rounded-2xl shadow-lg overflow-hidden mb-2 ring-1 ring-white/10">
            <img
              ...
              onError={e => {
                ...
                e.currentTarget.parentElement.style.background = "#0079da"
                e.currentTarget.parentElement.style.display = "flex"
                e.currentTarget.parentElement.style.alignItems = "center"
                e.currentTarget.parentElement.style.justifyContent = "center"
                e.currentTarget.parentElement.innerHTML = '<span style="color:#fff;font-size:22px;font-weight:800">W</span>'
              }}
            />
          </div>

          {/* ← único texto alterado */}
          <h1
            className="text-5xl md:text-6xl font-bold text-center tracking-tight"
            style={{ color: colors.textMain }}
          >
            Soluções de IA. Para você.
          </h1>
