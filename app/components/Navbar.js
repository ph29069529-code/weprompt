  ...
  return (
    <>
      ...
      <div style={{
        ...
        zIndex: 1000,
        width: "100%",
        padding: scrolled ? (isDesktop ? "16px 16px 0" : "12px 12px 0") : "0",
          ...
          <div style={{
            ...
            {isMobile && (
              <button onClick={() => setMobileOpen(!mobileOpen)} aria-label="Abrir menu"
                style={{
                  border: "none", background: "transparent", cursor: "pointer", padding: 11,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button onClick={() => setMobileOpen(false)} aria-label="Fechar menu"
              style={{ border: "none", background: "transparent", cursor: "pointer", fontSize: 22, color: "#1D1D1F", padding: 11, display: "flex", alignItems: "center", minWidth: 44, minHeight: 44 }}>
              ✕
            </button>
          </div>
